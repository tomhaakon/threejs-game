...
// node_modules/joystick-controller/dist/es/joystick-controller.js
...
var JoystickController = class {
  ...
  init() {
    if (!window[JOYSTICK_WINDOW_IDENTIFIER]) {
      window[JOYSTICK_WINDOW_IDENTIFIER] = /* @__PURE__ */ new Set();
    }
  ...
  destroy() {
    ...
    if (Array.isArray(window[JOYSTICK_WINDOW_ACTIVE]))
      window[JOYSTICK_WINDOW_ACTIVE] = window[JOYSTICK_WINDOW_ACTIVE].filter((joystick) => joystick !== this);
  }
};
var joystick_controller_default = JoystickController;
export {
  MOUSE_CLICK_BUTTONS,
  joystick_controller_default as default
};
